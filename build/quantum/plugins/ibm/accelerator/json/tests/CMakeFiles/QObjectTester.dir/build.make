...
quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/QObjectTester.cpp.o: ../quantum/plugins/ibm/accelerator/json/tests/QObjectTester.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspace/xacc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/QObjectTester.cpp.o"
	cd /workspace/xacc/build/quantum/plugins/ibm/accelerator/json/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/QObjectTester.dir/QObjectTester.cpp.o -c /workspace/xacc/quantum/plugins/ibm/accelerator/json/tests/QObjectTester.cpp
...
quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/QObjectTester.cpp.i: cmake_force
	...
	cd /workspace/xacc/build/quantum/plugins/ibm/accelerator/json/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspace/xacc/quantum/plugins/ibm/accelerator/json/tests/QObjectTester.cpp > CMakeFiles/QObjectTester.dir/QObjectTester.cpp.i
...
quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/QObjectTester.cpp.s: cmake_force
	...
	cd /workspace/xacc/build/quantum/plugins/ibm/accelerator/json/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspace/xacc/quantum/plugins/ibm/accelerator/json/tests/QObjectTester.cpp -o CMakeFiles/QObjectTester.dir/QObjectTester.cpp.s
...
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: tpls/cpr/opt/googletest/libgtest.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: quantum/plugins/ibm/libxacc-ibm.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: quantum/gate/libxacc-quantum-gate.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: quantum/observable/pauli/libxacc-pauli.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: quantum/observable/fermion/libxacc-fermion.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: xacc/libxacc.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: tpls/cppmicroservices/lib/libCppMicroServices.so.4.0.0
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: ../dist/libantlr4-runtime.so
quantum/plugins/ibm/accelerator/json/tests/QObjectTester: quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/workspace/xacc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable QObjectTester"
	cd /workspace/xacc/build/quantum/plugins/ibm/accelerator/json/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/QObjectTester.dir/link.txt --verbose=$(VERBOSE)
...
quantum/plugins/ibm/accelerator/json/tests/CMakeFiles/QObjectTester.dir/clean:
	cd /workspace/xacc/build/quantum/plugins/ibm/accelerator/json/tests && $(CMAKE_COMMAND) -P CMakeFiles/QObjectTester.dir/cmake_clean.cmake
